...
class search_model():
  def __init__(self):
    ...
    self.base_model=AutoModel.from_pretrained("ibm/MoLFormer-XL-both-10pct", deterministic_eval=True, trust_remote_code=True)
    ...
    #smiles
    self.smiles_bbbp=pd.read_csv(f'/content/drive/MyDrive/AI_store/Chemical_App/Source Code/AI_Model/AI_model_cache/Smiles Searching/Csv/bbbp.csv')
    self.smiles_bbbp=self.smiles_bbbp['smiles'].tolist()
    self.smiles_bace=pd.read_csv(f'/content/drive/MyDrive/AI_store/Chemical_App/Source Code/AI_Model/AI_model_cache/Smiles Searching/Csv/bace.csv')
    self.smiles_bace=self.smiles_bace['smiles'].tolist()
    self.smiles_ctox=pd.read_csv(f'/content/drive/MyDrive/AI_store/Chemical_App/Source Code/AI_Model/AI_model_cache/Smiles Searching/Csv/ctox.csv')
    self.smiles_ctox=self.smiles_ctox['smiles'].tolist()
    self.smiles_fda=pd.read_csv(f'/content/drive/MyDrive/AI_store/Chemical_App/Source Code/AI_Model/AI_model_cache/Smiles Searching/Csv/fda.csv')
    self.smiles_fda=self.smiles_fda['smiles'].tolist()
    self.smiles_freesolv=pd.read_csv(f'/content/drive/MyDrive/AI_store/Chemical_App/Source Code/AI_Model/AI_model_cache/Smiles Searching/Csv/freesolv.csv')
    self.smiles_freesolv=self.smiles_freesolv['smiles'].tolist()
    self.smiles_lipophilicity=pd.read_csv(f'/content/drive/MyDrive/AI_store/Chemical_App/Source Code/AI_Model/AI_model_cache/Smiles Searching/Csv/lipophilicity.csv')
